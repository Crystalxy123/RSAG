        ...
        const languageData = {
            'zh': {
                ...
                researchTitle: "研究方向",
                researchArea0Desc: "从事先进核反应堆安全分析与风险评价研究，致力于结合高性能计算和人工智能等技术，围绕核反应堆数值模拟、放射性核素行为与防护以及核电厂运行支持相关机理模型，建立高保真、高性能、智能化的安全和风险评价技术体系，改进核能系统效率及安全水平。具体研究方向包括蒙特卡罗粒子输运、放射性源项、辐射屏蔽、核反应堆多物理耦合分析、核应急决策技术、人因可靠性及核设计软件研发等。",
            ...
            'en': {
                ...
                researchArea0Desc:"[Research Area 0]",
